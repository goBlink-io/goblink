...
export const metadata: Metadata = {
  title: 'Sapphire - Cross-Chain Swap Platform',
  description: 'Seamless cross-chain swaps powered by NEAR Intents',
};
          ...
          <div className="min-h-screen bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-50">
            ...
            <footer className="mt-16 border-t border-gray-200 bg-white/50 py-8">
              <div className="container mx-auto px-4 text-center text-sm text-gray-600">
                <p>Cross-chain swaps made simple</p>
                <p className="mt-2">Supporting 20+ blockchains including Ethereum, Bitcoin, Solana, NEAR, and more</p>
                <p className="mt-2 text-xs">&copy; 2026 Sapphire. Powered by NEAR Intents.</p>
              </div>
            </footer>
          </div>
        </Web3Provider>
