...
export const WALLET_GUIDES: Record<string, ChainWalletConfig> = {
    ...
    wallets: [
      {
        ...
        chromeUrl: 'https://chromewebstore.google.com/detail/here-wallet/nlgbhdfgdhgbiamfdfmbikcdghidoadd',
        appStoreUrl: 'https://apps.apple.com/app/here-wallet-near-hot/id1635518249',
        playStoreUrl: 'https://play.google.com/store/apps/details?id=com.herewallet',
        detector: 'typeof window !== "undefined" && !!(window as any).here',
        description: 'The recommended NEAR wallet. Mobile-first with browser extension.',
        users: '10M+',
        primary: true,
        mobile: true,
        setupSteps: [
          'Install the HERE/HOT Wallet browser extension',
        ...
        mobileSetupSteps: [
          'Install HOT Wallet (HERE Wallet) from your app store',
      ...
      },
      {
        ...
        description: 'Browser-based NEAR wallet. No extension needed — works everywhere.',
        detector: 'false',
        users: '5M+',
        primary: false,
        mobile: true,
  ...
  sui: {
    ...
    wallets: [
      {
        name: 'Slush (Sui Wallet)',
        icon: '💧',
        url: 'https://slush.app',
        chromeUrl: 'https://chromewebstore.google.com/detail/slush-sui-wallet/opcgpfmipidbgpenhmajoajpbobppdil',
        ...
        description: 'The official Sui wallet by Mysten Labs, now rebranded as Slush.',
        users: '3M+',
        primary: true,
        mobile: true,
        mobileSetupSteps: [
          'Install Slush from your app store',
          'Open the app and tap "Create new wallet"',
          'Set a password and enable biometrics',
          'Write down your recovery phrase on paper',
          'Come back to goBlink and tap "Connect wallet"',
      ...
      },
      {
        ...
        chromeUrl: 'https://chromewebstore.google.com/detail/nightly/fiikommddbeccaoicoejoniammnalkfa',
        appStoreUrl: 'https://apps.apple.com/app/nightly-multichain-wallet/id6444768157',
        playStoreUrl: 'https://play.google.com/store/apps/details?id=com.aspect.nightly',
        detector: 'typeof window !== "undefined" && !!(window as any).nightly?.sui',
        description: 'Multi-chain wallet with native Sui support. Also works on Solana, EVM, and more.',
        users: '1M+',
        primary: false,
        mobile: true,
        multiChain: true,
